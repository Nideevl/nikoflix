...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(res.data.message || "Account created successfully! Please check your email for verification.")
    } catch (err) {
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-4 text-gray-400 font-medium">Or create account with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <input
                ...
                className="w-full px-4 py-3 enhanced-input text-white focus:outline-none"
                required
              />
              <input
                id="email"
